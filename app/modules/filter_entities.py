...
datasetspath = 'app/files/dataset_names'
with open(datasetspath, "r") as file:
    for row in file.readlines():
        dsnames.append(row.strip())

methodpath = 'app/files/method_names'
...
def filter_it(word, model):
    ...
    return (filtered_words, PMIdata, PMImethod, dssimilarity, mtsimilarity, ds_sim_50, ds_sim_60, ds_sim_70, ds_sim_80,
            ds_sim_90, mt_sim_50, mt_sim_60, mt_sim_70, mt_sim_80, mt_sim_90)
